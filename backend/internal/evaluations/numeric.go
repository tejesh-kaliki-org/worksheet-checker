...
// numericFromFloat64 converts an API-level float64 (Raw Score / Marks) into
// the pgtype.Numeric sqlc generates for the corresponding numeric column
// (see internal/questions/numeric.go for the identical pattern).
