...
import 'package:worksheet_checker/api/token_storage.dart';
...
@riverpod
ExamsClient examsClient(Ref ref) => ref.watch(restClientProvider).exams;

@riverpod
QuestionsClient questionsClient(Ref ref) =>
    ref.watch(restClientProvider).questions;
