...
String _$evaluationsClientHash() => r'335146d7a4abe45edf4ed7fa684cff707f0be97c';

/// See also [evaluationsClient].
@ProviderFor(evaluationsClient)
final evaluationsClientProvider =
    AutoDisposeProvider<EvaluationsClient>.internal(
  evaluationsClient,
  name: r'evaluationsClientProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$evaluationsClientHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef EvaluationsClientRef = AutoDisposeProviderRef<EvaluationsClient>;
