...
import 'evaluations/evaluations_client.dart';
...
class RestClient {
  ...
  EvaluationsClient? _evaluations;
  ExamsClient? _exams;
  ...
  EvaluationsClient get evaluations => _evaluations ??= EvaluationsClient(_dio, baseUrl: _baseUrl);
